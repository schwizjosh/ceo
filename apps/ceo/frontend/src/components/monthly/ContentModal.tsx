...
export const ContentModal: React.FC<ContentModalProps> = ({
  ...
  // Debug logging
  useEffect(() => {
    console.log('ContentModal Debug State:', {
      canEdit,
      isExpanding,
      isRefining,
  ...
  // Prevent body scroll when modal is open and add modal-open class for footer hiding
  useEffect(() => {
    if (isOpen) {
    ...
    <div className="fixed inset-0 z-[100] flex flex-col">
      ...
      <div className="relative z-10 flex-1 overflow-y-auto">
        <div className="min-h-full bg-white">
          {/* Header - Sticky */}
          <div className="sticky top-0 bg-white/95 backdrop-blur-lg border-b border-slate-200 z-20 shadow-sm">
